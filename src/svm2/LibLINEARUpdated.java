...
import static weka.classifiers.functions.LibLINEAR.isPresent;
 ...
 */
public class LibLINEARUpdated
  extends Classifier
  implements TechnicalInformationHandler {

  /** the svm classname */
  protected final static String CLASS_LINEAR = "de.bwaldvogel.liblinear.Linear";

  /** the svm_model classname */
  protected final static String CLASS_MODEL = "de.bwaldvogel.liblinear.Model";

  /** the svm_problem classname */
  protected final static String CLASS_PROBLEM = "de.bwaldvogel.liblinear.Problem";

  /** the svm_parameter classname */
  protected final static String CLASS_PARAMETER = "de.bwaldvogel.liblinear.Parameter";

  /** the svm_parameter classname */
  protected final static String CLASS_SOLVERTYPE = "de.bwaldvogel.liblinear.SolverType";

  /** the svm_node classname */
  protected final static String CLASS_FEATURENODE = "de.bwaldvogel.liblinear.FeatureNode";

  /** serial UID */
  protected static final long serialVersionUID = 230504711;

  /** LibLINEARUpdated Model */
