...
public class SVM {
    ...
    /**
     * run svm with given configurations
     *
     * @throws Exception
     */
    public void run() throws Exception {
        ...
        crossValidate(svm,dataFiltered);

    }

    /**
     * create test instances by loading articles from the data base
     *
     * @return
     * @throws Exception
     */
    ...
    public void saveTrainingDataToFile() throws Exception {
        ...
        /**
         * given in research papers as stemming , here we go forward as use
         * lemmatizer feature selection has not performed as "how to" paper say
         * that it wont improve accuracy in SVM and our dictionary is small
         */
        ...
        System.out.println("Total Num of Insatances= " + articleCount);
    ...
    /**
     * cross validate given svm model
     * @param svm
     * @param dataFiltered
     * @throws Exception 
     */
    private void crossValidate(LibSVM svm,Instances dataFiltered) throws Exception {
