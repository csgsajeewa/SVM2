...
/**
 * Access support vectors of the classifier
 * @author chamath 
 */
public class SVMWithInternalMethods {
    ...
    public static void main(String[] args) {
        ...
        SVMWithInternalMethods svm = new SVMWithInternalMethods();
        try {
            svm.run();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /**
     * classify given documents and extract support vectors of both classes
     *
     * @throws Exception
     */
