...
/**
 * 1. calculate sim hash for each document ( 64 bit sim hash) 2. build the smart
 * index ( key is 12 bit vlaue, values are doc IDs) 3. then calculate hamming
 * distance between simhash values. ( difference threshold is 3)
 *
 * @author chamath
 */
public class Main {
    ...
    /**
     * currently this method takes strings(documents) from file, should be
     * changed to get from data base
     *
     * @param args
     * @return
     * @throws IOException
